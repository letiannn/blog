# RTT Clang-Format 配置文档

## 在VSCode内如何使用

1. 在VSCode内下载插件 `Clang-Format`
2. 找到VSCode安装目录内的 `C:\Users\tian\.vscode\extensions\ms-vscode.cpptools-1.29.3-win32-x64\LLVM\bin\clang-format.exe` 文件
3. 配置到VSCode内插件运行路径
4. 将本配置文件保存为项目根目录的 `.clang-format`

---

## .clang-format-ignore 配置
...
```yaml
# 可用的样式选项参考: https://clang.llvm.org/docs/ClangFormatStyleOptions.html
#
...
AlignTrailingComments:           # 尾随注释对齐
  Kind: Leave                    # 保持原样
  OverEmptyLines: 1              # 跨空行对齐
